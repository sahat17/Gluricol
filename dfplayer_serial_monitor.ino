...
void loop() {
  ...
  Serial.print("Gula Darah Puasa: ");
  Serial.println(bloodGlucoseFasting);
  
  Serial.print("Gula Darah 2 Jam Setelah Makan: ");
  Serial.println(bloodGlucosePostMeal);
  
  Serial.print("Gula Darah Acak: ");
  Serial.println(randomBloodGlucose);
  
  Serial.print("Kolesterol: ");
  Serial.println(cholesterol);
  
  Serial.print("Asam Urat: ");
  Serial.println(uricAcid);
